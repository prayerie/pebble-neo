...
function weatherFromLoc(loc) {
  ...
  xhrRequest(url, 'GET', 
    function(responseText) {
      ...
      console.log(conditions_description)
      var dictionary = {
        "TEMPERATURE": temperature,
        "CONDITIONS": conditions,
        "CONDITIONS_DESC": conditions_description
      };
...
if (!localStorage.getItem("customLoc") && localStorage.getItem("customLoc") != "undefined") {
...
function getWeather() {
  ...
  if (customLoc && localStorage.getItem("customLoc") != "undefined") {
    console.log("Custom location isn't blank: " + customLoc);
